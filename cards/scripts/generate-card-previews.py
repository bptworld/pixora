...
CUSTOM = {
    ...
    "stocks": _stock,
    "commodities_watch": lambda: _message("CMDTY", "GOLD 2340", "+0.8%", (255, 205, 80)),
    "currency_rates": lambda: _message("FX RATES", "EUR 1.08", "+0.1%", (120, 220, 255)),
    "market_indexes": _market,
    "market_status": _market_status,
    "portfolio_pulse": _portfolio,
    "sector_heat": lambda: _message("SECTORS", "TECH +1.2%", "FIN -0.3%", (100, 190, 255)),
    ...
    "tide_tracking": lambda: _message("TIDE", "HIGH 6:42P", "RISING", (95, 230, 255)),
    "beach_conditions": lambda: _message("BEACH", "GOOD", "72F 2FT", (120, 255, 150)),
    "marine_forecast": lambda: _message("MARINE", "OK 2FT", "W 8MPH", (95, 230, 255)),
    "boating_conditions": lambda: _message("BOATING", "GO", "SEAS 2FT", (120, 255, 150)),
    "fishing_window": lambda: _message("FISHING", "GOOD", "HIGH 6P", (120, 255, 150)),
    "surf_report": lambda: _message("SURF", "FAIR", "3FT 9S", (255, 218, 84)),
    "rip_current_risk": lambda: _message("RIP RISK", "LOW", "NO ALERT", (120, 255, 150)),
