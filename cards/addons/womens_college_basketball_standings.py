...
CARD_ID = "womens_college_basketball_standings"
CARD_NAME = "Women's College Basketball Standings"
CARD_DETAIL = "Women's college basketball standings"
CARD_OPTIONS = [
    {
        "key": "group",
        "label": "Conference",
...
def render(options=None):
    ...
    opts["league"] = "womens_college_basketball"
    return _render(opts)
